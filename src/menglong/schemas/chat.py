...
from menglong.utils.multimodal_utils import load_image_from_path, load_document_from_path, load_audio_from_path, load_video_from_path
        ...
        if isinstance(val, str):
            if val.startswith("http://") or val.startswith("https://"):
                ...
                if Path(val).exists():
                    ...
                    parts.append(ImagePart(data=data, media_type=media_type, detail=detail))
                else:
                    # 假设是 Base64
