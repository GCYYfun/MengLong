...
class MengLongProvider(BaseProvider):
    ...
    def _normalize_response(self, response_data: Dict[str, Any], model: str) -> Response:
        """将 MengLong API 响应归一化为 SDK Response 对象"""
        # MengLong API 响应结构与 SDK schemas 一致，直接解析
        return Response.model_validate(response_data)
    
    def _normalize_stream_chunk(self, chunk_data: Dict[str, Any], model: str) -> StreamResponse:
